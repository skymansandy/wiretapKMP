...
import dev.skymansandy.wiretap.ui.screens.home.WiretapHomeViewModel.Companion.HTTP_SUB_TAB_LOGS
import dev.skymansandy.wiretap.ui.screens.home.WiretapHomeViewModel.Companion.TAB_HTTP
import dev.skymansandy.wiretap.ui.screens.home.WiretapHomeViewModel.Companion.TAB_WEBSOCKET
                ...
                TAB_HTTP -> Column(
                    ...
                    AnimatedVisibility(
                        ...
                        SecondaryTabRow(
                            ...
                            Tab(
                                selected = httpSubTab == WiretapHomeViewModel.Companion.HTTP_SUB_TAB_RULES,
                                onClick = { viewModel.selectHttpSubTab(WiretapHomeViewModel.Companion.HTTP_SUB_TAB_RULES) },
                                text = { Text("Rules") },
                            )
                        }
                    }
                    ...
                    when (httpSubTab) {
                        HTTP_SUB_TAB_LOGS -> HttpLogList(
                            ...
                            onHttpClick = {
                                navigator.pushDetailPane(
                                    WiretapScreen.HttpDetailScreen(
                                        it.id,
                                    ),
                                )
                            },
                            onCreateRule = {
                                navigator.pushDetailPane(
                                    WiretapScreen.CreateRuleScreen(
                                        prefillFromLogId = it.id,
                                    ),
                                )
                            },
                            onViewRule = { ruleId ->
                                navigator.pushDetailPane(
                                    WiretapScreen.RuleDetailScreen(
                                        ruleId,
                                    ),
                                )
                            },
                        ...
                        WiretapHomeViewModel.HTTP_SUB_TAB_RULES -> RulesListScreen(
                            ruleRepository = ruleRepository,
