...
class RuleFormExtensionsTest : DescribeSpec({
    isolationMode = IsolationMode.InstancePerLeaf

    describe("UrlMatchMode isRegex") {
        it("only true for Regex variant") {
    ...
    describe("BodyMatchMode isRegex") {
        it("only true for Regex variant") {
    ...
    describe("HeaderEntryMode") {
        it("isRegex only true for ValueRegex variant") {
        ...
        it("hasValue is false only for KeyExists") {
    ...
    describe("toUrlMode") {
        it("returns matching mode for each UrlMatcher subtype") {
        ...
        it("returns null when rule has no url matcher") {
            ruleWith(url = null).toUrlMode() shouldBe null
        }
    }

    describe("toBodyMode") {
        it("returns matching mode for each BodyMatcher subtype") {
        ...
        it("returns null when rule has no body matcher") {
            ruleWith(body = null).toBodyMode() shouldBe null
        }
    }

    describe("HeaderMatcher toEntry") {
        it("KeyExists matcher maps to HeaderEntry with KeyExists mode and blank value") {
        ...
        it("ValueExact maps key and value with ValueExact mode") {
        ...
        it("ValueContains maps key and value with ValueContains mode") {
        ...
        it("ValueRegex maps pattern into the value field with ValueRegex mode") {
    ...
    describe("HeaderEntry toDomain") {
        ...
        it("produces KeyExists matcher with trimmed key only") {
        ...
        it("produces every value-mode variant") {
    ...
    describe("testRegex") {
        it("returns matches true with null error on a valid match") {
        ...
        it("returns matches false with null error on no match") {
        ...
        it("returns matches false with non-null error for invalid pattern") {
    ...
    describe("urlFieldLabel") {
        it("returns human-readable label per mode") {
    ...
    describe("urlWarning") {
        ...
        it("is null when pattern is non-blank") {
        ...
        it("returns a mode-specific message when pattern is blank") {
    ...
    describe("headersWarning") {
        it("is null for empty list") {
            headersWarning(emptyList()) shouldBe null
        }

        it("flags blank key first") {
            val entries = listOf(
        ...
        it("is null when KeyExists has blank value") {
            val entries = listOf(
        ...
        it("emits mode-specific message for blank value") {
            headersWarning(
        ...
        it("returns null when every entry is valid") {
            val entries = listOf(
    ...
    describe("urlPlaceholder") {
        it("returns a mode-specific example") {
    ...
    describe("headerValuePlaceholder") {
        it("is empty string for KeyExists mode") {
            headerValuePlaceholder(HeaderEntryMode.KeyExists) shouldBe ""
        }

        it("returns mode-specific examples") {
