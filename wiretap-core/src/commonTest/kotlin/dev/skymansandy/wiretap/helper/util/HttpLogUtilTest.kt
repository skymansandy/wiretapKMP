...
class HttpLogUtilTest {
    ...
    @Test
    fun `buildShareText starts with method status and url`() {
    ...
    @Test
    fun `buildShareText reports duration and source`() {
    ...
    @Test
    fun `buildShareText omits optional network metadata when null`() {
    ...
    @Test
    fun `buildShareText emits all metadata lines when populated`() {
        val text = buildShareText(
            log(
                protocol = "HTTP/2",
    ...
    @Test
    fun `buildShareText prints none placeholder for absent request headers and body`() {
    ...
    @Test
    fun `buildShareText lists headers as key colon value lines`() {
        val text = buildShareText(
            log(
    ...
    @Test
    fun `buildShareText embeds the response body verbatim at the end`() {
    ...
    @Test
    fun `buildCurlCommand emits method and url`() {
    ...
    @Test
    fun `buildCurlCommand emits -H flag per header`() {
    ...
    @Test
    fun `buildCurlCommand emits --data-raw when request body is present`() {
    ...
    @Test
    fun `buildCurlCommand omits --data-raw for empty body`() {
    ...
    @Test
    fun `buildCurlCommand omits --data-raw for null body`() {
