...
class SocketEntityMappersTest {

    @Test
    fun `SocketLogEntity to domain copies every scalar field`() {
    ...
    @Test
    fun `every SocketStatus value round-trips through the entity`() {
    ...
    @Test
    fun `null closeCode in entity round-trips as null in domain`() {
    ...
    @Test
    fun `SocketMessageEntity to domain maps direction and content type by name`() {
