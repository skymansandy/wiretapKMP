...
class HttpLogEntityMapperTest : DescribeSpec({
    isolationMode = IsolationMode.InstancePerLeaf

    describe("entity to domain") {
        ...
        it("with null response body produces zero response body size") {
    ...
    describe("round-trip") {
        it("domain to entity to domain preserves data") {
        ...
        it("every ResponseSource value round-trips through the entity") {
    ...
    describe("projection to domain") {
        it("copies metadata and computes response body size from column") {
