...
```kotlin
debugImplementation("dev.skymansandy:wiretap-ktor:1.0.0-SNAPSHOT")
releaseImplementation("dev.skymansandy:wiretap-ktor-noop:1.0.0-SNAPSHOT")
```
...
sourceSets {
    commonMain {
        dependencies {
            implementation("dev.skymansandy:wiretap-ktor:1.0.0-SNAPSHOT")
        }
    }
}
```
