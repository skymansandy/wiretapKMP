...
debugImplementation("dev.skymansandy:wiretap-ktor:1.0.0-RC8")
releaseImplementation("dev.skymansandy:wiretap-ktor-noop:1.0.0-RC8")
```
...
```kotlin
debugImplementation("dev.skymansandy:wiretap-okhttp:1.0.0-RC8")
releaseImplementation("dev.skymansandy:wiretap-okhttp-noop:1.0.0-RC8")
```
