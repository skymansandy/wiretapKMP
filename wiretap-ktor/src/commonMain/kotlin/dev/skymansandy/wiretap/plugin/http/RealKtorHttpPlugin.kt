...
/**
 * Real implementation of [WiretapKtorHttpPluginDelegate] that logs
 * HTTP requests/responses and evaluates mock/throttle rules.
 */
internal class RealKtorHttpPlugin : WiretapKtorHttpPluginDelegate {

    @Suppress("LongMethod", "CyclomaticComplexMethod")
    @OptIn(InternalAPI::class)
    override fun ClientPluginBuilder<WiretapConfig>.install() {
