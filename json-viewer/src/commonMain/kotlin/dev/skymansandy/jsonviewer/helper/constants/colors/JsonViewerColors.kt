package dev.skymansandy.jsonviewer.helper.constants.colors
...
data class JsonViewerColors(
    ...
    companion object {
        ...
        val SolarizedDark = JsonViewerColors(
